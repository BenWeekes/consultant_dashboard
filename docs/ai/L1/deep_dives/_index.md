...
This repo now follows the progressive disclosure structure, but deep dives are intentionally deferred until the corresponding subsystem becomes more complex.
...
- `auth_and_roles.md` — consultant/admin auth states, session handling, and future 2FA/CSRF/rate-limit work. To be created.
