...
def initialize_constants(profile=None):
    ...
    constants = {
        ...
        "CUSTOM_LLM_INBOUND_SECRET": get_env_var('CUSTOM_LLM_INBOUND_SECRET', profile),
        "LLM_MODEL": get_env_var('LLM_MODEL', profile, "gpt-4o-mini"),
        "LLM_REASONING_EFFORT": get_env_var('LLM_REASONING_EFFORT', profile),
        ...
        "GRADIUM_MODEL_NAME": get_env_var('GRADIUM_MODEL_NAME', profile, "default"),
        ...
        "SHEN_AVAILABLE": (
            str(get_env_var("SHEN_AVAILABLE", profile, os.environ.get("SHEN_AVAILABLE", "true"))).lower()
            == "true"
        ),
